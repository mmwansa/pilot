...
const dashboard = new Vue({
    ...
    methods: {
        ...
        resizeCharts() {
            ...
            this.demographicsHeight = Math.max(demographicsRef.clientHeight - 1, 185);  // Enforce min height

            this.codWidth = codRef.clientWidth - 1;
            this.codHeight = Math.max(codRef.clientHeight - 1, 185);  // Enforce min height
        },
